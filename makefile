...
# Basic Configuration
#
APPNAME=BLE_Mesh_ProvisionClient
TOOLCHAIN=GCC_ARM
CONFIG=Debug
VERBOSE=
...
MESH_MODEL_ONOFF_CLIENT_INCLUDED?=1
MESH_MODEL_LEVEL_CLIENT_INCLUDED?=1
MESH_MODEL_LIGHT_LIGHTNESS_CLIENT_INCLUDED?=1
MESH_MODEL_LIGHT_HSL_CLIENT_INCLUDED?=1
MESH_MODEL_LIGHT_CTL_CLIENT_INCLUDED?=1
MESH_MODEL_LIGHT_XYL_CLIENT_INCLUDED?=0
MESH_MODEL_SENSOR_CLIENT_INCLUDED?=1
MESH_MODEL_LIGHT_LC_CLIENT_INCLUDED?=0
MESH_MODEL_SCENE_CLIENT_INCLUDED?=1
MESH_MODEL_PROPERTY_CLIENT_INCLUDED?=0
MESH_MODEL_BATTERY_CLIENT_INCLUDED?=0
MESH_MODEL_LIGHT_XYL_CLIENT_INCLUDED?=0
MESH_MODEL_LOCATION_CLIENT_INCLUDED?=0
MESH_MODEL_POWER_LEVEL_CLIENT_INCLUDED?=0
MESH_MODEL_POWER_ONOFF_CLIENT_INCLUDED?=0
MESH_MODEL_SCHEDULER_CLIENT_INCLUDED?=0
MESH_MODEL_TIME_CLIENT_INCLUDED?=0
...
COMPONENTS += mesh_app_lib gatt_utils_lib
